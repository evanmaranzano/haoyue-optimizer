    ...
    return [
        ...
        Optimization(
            ...
            actions=[
                ...
                RegistrySetAction("HKLM", r"SYSTEM\CurrentControlSet\Services\kbdclass\Parameters", "KeyboardDataQueueSize", 16, "dword"),
        ...
        Optimization(
            id="optimize_mouse_hover_delay",
            title="优化鼠标悬停延迟",
            category="input",
            preset="safe",
            risk="green",
            evidence="medium",
            benefit=["将鼠标悬停延迟从默认 400ms 降低到 10ms，工具提示更快响应"],
            side_effects=["鼠标悬停触发速度显著加快，可能增加误触提示"],
            legacy_ids=[],
            actions=[
                RegistrySetAction("HKCU", r"Control Panel\Mouse", "MouseHoverTime", "10", "sz"),
            ],
        ),
        Optimization(
            ...
            actions=[
                ...
                RegistrySetAction("HKLM", r"SYSTEM\CurrentControlSet\Services\mouclass\Parameters", "MouseDataQueueSize", 16, "dword"),
